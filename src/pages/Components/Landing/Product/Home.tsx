                    ...
                    <div className="grid items-center grid-cols-12 gap-5 2xl:grid-cols-12">
                        <div className="col-span-12 xl:col-span-5 2xl:col-span-5">
                            ...
                            <div className="flex items-center gap-2" data-aos="fade-right" data-aos-delay="800">
                                <button type="button" className="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500" > <a href="https://docs.google.com/document/d/1bc1xs40bpezpeMteYf17X3ePUHLHYnhFbmEYqRGHrhU/edit?usp=sharing" target={"_blank"}>View Resume <Book className="inline-block size-4 align-middle rtl:mr-1 ltr:ml-1" /></a>
                                </button>

                                <button type="button" className="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500" > <a href="https://docs.google.com/document/d/1bc1xs40bpezpeMteYf17X3ePUHLHYnhFbmEYqRGHrhU/edit?usp=sharing" target={"_blank"}>Watch Video Resume <Video className="inline-block size-4 align-middle rtl:mr-1 ltr:ml-1" /></a>
                                </button>
                            </div>
                        </div>
