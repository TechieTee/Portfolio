                ...
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                    <div className="grid items-center grid-cols-12 gap-5 2xl:grid-cols-12">
                        <div className="col-span-12 xl:col-span-5 2xl:col-span-5">
                            ...
                            <h2 className="mb-4 !leading-normal lg:text-2xl 2xl:text-6xl dark:text-zinc-100" data-aos="fade-right" data-aos-delay="300">Frontend Engineer / Wordpress Developer</h2>
                            <p className="text-lg mb-7 text-slate-500 dark:text-zinc-400" data-aos="fade-right" data-aos-delay="600">I am a Frontend Engineer with 4+ years of experience building scalable, responsive, and user-focused web applications. Skilled in React.js, TypeScript, Next.js, Vue.js, and REST API integration, I excel at turning Figma designs into clean, functional interfaces that enhance engagement and business growth. <br /><br /> As a WordPress Developer, I have delivered 20+ websites using Elementor, Oxygen, Kadence, and Gutenberg, combining creativity and logic to craft seamless user experiences. From building custom plugins to optimizing for SEO, I help businesses gain visibility, improve performance, and achieve sustainable digital growth. </p>
                            <div className="flex items-center gap-2" data-aos="fade-right" data-aos-delay="800">
                                <button type="button" className="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500" > <a href="https://drive.google.com/file/d/1JUmFjM71ekFpkdCMhy_aLuJXpI0DYzXf/view?usp=sharing" target={"_blank"}>View Resume <Book className="inline-block size-4 align-middle rtl:mr-1 ltr:ml-1" /></a>
                                </button>

                                <button type="button" className="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500" > <a href="https://drive.google.com/file/d/1JUmFjM71ekFpkdCMhy_aLuJXpI0DYzXf/view?usp=sharing" target={"_blank"}>Watch Video Resume <Video className="inline-block size-4 align-middle rtl:mr-1 ltr:ml-1" /></a>
                                </button>
                            </div>
                        </div>
