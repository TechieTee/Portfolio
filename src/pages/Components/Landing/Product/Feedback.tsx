...
const Feedback = () => {
    ...
    return (
        <React.Fragment>
            ...
            <section className="relative py-4 border-t border-slate-200 dark:border-zinc-800">
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                    <div className="grid items-center grid-cols-1 gap-5 lg:grid-cols-12">
                        ...
                        <div className="ltr:lg:text-right rtl:lg:text-left lg:col-span-4">
                            <form action="#!" className="relative" data-aos="fade-left">
                                <input type="email" id="subscribeInput" className="py-3 ltr:pr-40 rtl:pl-40 bg-slate-100 dark:bg-zinc-800/40 form-input text-slate-200 border-slate-200 dark:border-zinc-800 focus:outline-none focus:border-custom-500 dark:focus:border-custom-500 placeholder:text-slate-500 dark:placeholder:text-zinc-400 backdrop-blur-md" autoComplete="off" placeholder="mailtomodupe@gmail.com" required />
                                <button type="submit" className="absolute px-6 py-2 text-base transition-all duration-200 ease-linear border-0 ltr:right-1 rtl:left-1 text-custom-50 btn top-1 bottom-1 bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500">Reach Out</button>
                            </form>
                        </div>
                    </div>
                </div>
